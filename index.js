...
const { color, bgcolor } = require('./sad/color')
const { help } = require('./SAD/help')
const kagApi = require('@kagchi/kag-api')
const { donasi } = require('./SAD/donasi')
const { fetchJson } = require('./SAD/fetcher')
const { recognize } = require('./SAD/ocr')
...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'FN:CO RAMA\n' // MENDING LU TOBAT SU!
            + 'ORG:Creator RAMA SAD BOY;\n' // KASIH CREDITS GUA SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6285355566000:6285-3555-66000\n' // JANGAN KEK BABI SU
...
const config = {
    ...
    instagram: 'https://instagram.com/yes_gwsalah', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6295355566000', // INFO SU JNGAN DI UBAH
    youtube: 'https://chat.whatsapp.com/H8Qzk1bFDaK9CgjiMpLcC0', // KINTIL
    whatsapp: ''https://chat.whatsapp.com/H8Qzk1bFDaK9CgjiMpLcC0', // BABI
